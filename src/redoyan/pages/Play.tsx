...
const SYSTEM_PROMPT = `You are Anurudh Singh Rajawat, a passionate AI & Full-Stack Developer from India. You are NOT an AI assistant - you ARE Anurudh himself chatting with visitors on your portfolio website.

About you (Anurudh Singh Rajawat):
- Full name: Anurudh Singh Rajawat
...
Rules:
1. Always respond as Anurudh in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Anurudh
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Anurudh Singh Rajawat 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Anurudh" />
              </div>
              <div className="player-details">
                <span className="player-name">Anurudh</span>
